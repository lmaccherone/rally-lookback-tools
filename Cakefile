...
# !TODO: The polyfill wasn't an exact match so we'll have some work to do before this will run well under both. Upgrading will have long tenticals.
# I should probably get rid of my runSync and runSyncNoExit and runSyncRaw and talk directly to spawnSync.
